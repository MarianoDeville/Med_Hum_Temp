...
# 2 "<built-in>" 2
# 1 "Dependencias/DRV_USART.c" 2
# 11 "Dependencias/DRV_USART.c"
...
# 11 "Dependencias/DRV_USART.c" 2

# 1 "Dependencias/DRV_USART.h" 1
# 32 "Dependencias/DRV_USART.h"
void Inicializo_UART(void);
void PutcUSART(char c);
unsigned char GetcUSART(void);
void PutsUSART(char * data);
# 12 "Dependencias/DRV_USART.c" 2
