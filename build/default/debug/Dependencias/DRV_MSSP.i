...
# 2 "<built-in>" 2
# 1 "Dependencias/DRV_MSSP.c" 2
# 11 "Dependencias/DRV_MSSP.c"
...
void MSSP_Setup(char modo,const unsigned long velocidad)
{
    if(modo==1)
    {
        ...
        SSP1CON1=0b00101000;
        SSP1CON2=0b00000000;
        SSP1ADD=(12000000/(4*velocidad))-1;
        BCLIF=0;
    }
    return;
}
